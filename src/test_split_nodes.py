...
class TestTextNode(unittest.TestCase):
    ...
    def test_split_images_image_at_start_and_end(self):
        node = TextNode(
            "![first](https://i.imgur.com/first.png) middle ![second](https://i.imgur.com/second.png)",
            TextType.TEXT,
        )
        new_nodes = split_nodes_image([node])
        self.assertListEqual(
